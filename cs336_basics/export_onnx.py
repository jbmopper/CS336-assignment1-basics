...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output metadata JSON path (default: <out>.metadata.json).",
    )
...
def main() -> None:
    ...
    if not args.skip_validate:
        validation = _validate_export(args.out, model, dummy)

    metadata_out = args.metadata_out or args.out.with_suffix(args.out.suffix + ".metadata.json")
    _write_metadata(
